@echo off
cls
title TECHGUYTOOL - MOTOROLA OTA IDIOT PROOF
color 0A
...
echo(
echo   Motorola helper codes (model dependent):
echo     *#*#4636#*#*  (generic)
echo(
echo ===============================================================================
echo(
...
:: ---- TOAST START ----
adb shell am broadcast -a com.android.systemui.toast --es message "TechGuyTool: Locking Motorola OTA..." --ei duration 1 >nul 2>&1

:: ---- CLEAR + DISABLE ----
echo [*] Clearing updater state...
adb shell pm clear com.motorola.ccc.ota >nul 2>&1
adb shell pm clear com.motorola.blur.service.main >nul 2>&1

echo [*] Disabling updater services...
adb shell pm disable-user --user 0 com.motorola.ccc.ota >nul 2>&1
adb shell pm disable-user --user 0 com.motorola.blur.service.main >nul 2>&1

:: ---- DONE TOAST ----
adb shell am broadcast -a com.android.systemui.toast --es message "TechGuyTool: Motorola OTA - IDIOT PROOF ✅" --ei duration 1 >nul 2>&1
