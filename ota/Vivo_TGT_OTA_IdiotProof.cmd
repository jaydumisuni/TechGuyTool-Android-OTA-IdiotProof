@echo off
cls
title TECHGUYTOOL - VIVO OTA IDIOT PROOF
color 0A
...
echo(
echo   Vivo / iQOO helper codes (model dependent):
echo     *#*#4636#*#*  (generic)
echo(
echo ===============================================================================
echo(
...
:: ---- TOAST START ----
adb shell am broadcast -a com.android.systemui.toast --es message "TechGuyTool: Locking Vivo OTA..." --ei duration 1 >nul 2>&1

:: ---- CLEAR + DISABLE ----
echo [*] Clearing updater state...
adb shell pm clear com.vivo.updater >nul 2>&1
adb shell pm clear com.bbk.updater >nul 2>&1
adb shell pm clear com.android.providers.downloads >nul 2>&1

echo [*] Disabling updater services...
adb shell pm disable-user --user 0 com.vivo.updater >nul 2>&1
adb shell pm disable-user --user 0 com.bbk.updater >nul 2>&1
adb shell pm disable-user --user 0 com.android.providers.downloads >nul 2>&1

:: ---- DONE TOAST ----
adb shell am broadcast -a com.android.systemui.toast --es message "TechGuyTool: Vivo OTA - IDIOT PROOF ✅" --ei duration 1 >nul 2>&1
