@echo off
cls
title TECHGUYTOOL - XIAOMI OTA IDIOT PROOF
color 0A
...
echo(
echo   Xiaomi helper codes (model dependent):
echo     *#*#6484#*#*  Hardware test (some Xiaomi)
echo     *#*#4636#*#*  Testing / network info (generic)
echo(
echo ===============================================================================
echo(
...
:: ---- TOAST START (BEST-EFFORT) ----
adb shell am broadcast -a com.android.systemui.toast --es message "TechGuyTool: Locking Xiaomi OTA..." --ei duration 1 >nul 2>&1

:: ---- CLEAR + DISABLE ----
echo [*] Clearing updater state...
adb shell pm clear com.miui.updater >nul 2>&1
adb shell pm clear com.xiaomi.update >nul 2>&1
adb shell pm clear com.android.providers.downloads >nul 2>&1

echo [*] Disabling updater services...
adb shell pm disable-user --user 0 com.miui.updater >nul 2>&1
adb shell pm disable-user --user 0 com.xiaomi.update >nul 2>&1
adb shell pm disable-user --user 0 com.android.providers.downloads >nul 2>&1

:: ---- DONE TOAST ----
adb shell am broadcast -a com.android.systemui.toast --es message "TechGuyTool: Xiaomi OTA - IDIOT PROOF ✅" --ei duration 1 >nul 2>&1
