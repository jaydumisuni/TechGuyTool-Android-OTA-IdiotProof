@echo off
cls
title TECHGUYTOOL - OPPO/REALME OTA IDIOT PROOF
color 0A
...
echo(
echo   Oppo / Realme helper codes (model dependent):
echo     *#801#       (some Oppo service)
echo     *#*#4636#*#* (generic testing)
echo(
echo ===============================================================================
echo(
...
:: ---- TOAST START ----
adb shell am broadcast -a com.android.systemui.toast --es message "TechGuyTool: Locking Oppo/Realme OTA..." --ei duration 1 >nul 2>&1

:: ---- CLEAR + DISABLE ----
echo [*] Clearing updater state...
adb shell pm clear com.oppo.ota >nul 2>&1
adb shell pm clear com.coloros.ota >nul 2>&1
adb shell pm clear com.realme.update >nul 2>&1
adb shell pm clear com.android.providers.downloads >nul 2>&1

echo [*] Disabling updater services...
adb shell pm disable-user --user 0 com.oppo.ota >nul 2>&1
adb shell pm disable-user --user 0 com.coloros.ota >nul 2>&1
adb shell pm disable-user --user 0 com.realme.update >nul 2>&1
adb shell pm disable-user --user 0 com.android.providers.downloads >nul 2>&1

:: ---- DONE TOAST ----
adb shell am broadcast -a com.android.systemui.toast --es message "TechGuyTool: Oppo/Realme OTA - IDIOT PROOF ✅" --ei duration 1 >nul 2>&1
