@echo off
cls
title TECHGUYTOOL - SONY OTA IDIOT PROOF
color 0A
...
echo(
echo   Sony helper codes (model dependent):
echo     *#*#7378423#*#*  (Sony service menu)
echo(
echo ===============================================================================
echo(
...
:: ---- TOAST START ----
adb shell am broadcast -a com.android.systemui.toast --es message "TechGuyTool: Locking Sony OTA..." --ei duration 1 >nul 2>&1

:: ---- CLEAR + DISABLE ----
echo [*] Clearing updater state...
adb shell pm clear com.sonymobile.updatecenter >nul 2>&1
adb shell pm clear com.sonymobile.update.service >nul 2>&1

echo [*] Disabling updater services...
adb shell pm disable-user --user 0 com.sonymobile.updatecenter >nul 2>&1
adb shell pm disable-user --user 0 com.sonymobile.update.service >nul 2>&1

:: ---- DONE TOAST ----
adb shell am broadcast -a com.android.systemui.toast --es message "TechGuyTool: Sony OTA - IDIOT PROOF ✅" --ei duration 1 >nul 2>&1
