@echo off
cls
title TECHGUYTOOL - ONEPLUS OTA IDIOT PROOF
color 0A
...
echo(
echo   OnePlus helper codes (model dependent):
echo     *#*#4636#*#*  (generic)
echo(
echo ===============================================================================
echo(
...
:: ---- TOAST START ----
adb shell am broadcast -a com.android.systemui.toast --es message "TechGuyTool: Locking OnePlus OTA..." --ei duration 1 >nul 2>&1

:: ---- CLEAR + DISABLE ----
echo [*] Clearing updater state...
adb shell pm clear com.oneplus.opbackup >nul 2>&1
adb shell pm clear com.oneplus.ota >nul 2>&1
adb shell pm clear com.android.providers.downloads >nul 2>&1

echo [*] Disabling updater services...
adb shell pm disable-user --user 0 com.oneplus.opbackup >nul 2>&1
adb shell pm disable-user --user 0 com.oneplus.ota >nul 2>&1
adb shell pm disable-user --user 0 com.android.providers.downloads >nul 2>&1

:: ---- DONE TOAST ----
adb shell am broadcast -a com.android.systemui.toast --es message "TechGuyTool: OnePlus OTA - IDIOT PROOF ✅" --ei duration 1 >nul 2>&1
