@echo off
cls
title TECHGUYTOOL - HUAWEI / HONOR OTA IDIOT PROOF
color 0A
...
echo(
echo   Huawei / Honor helper codes (Android-era devices):
echo     *#*#4636#*#*  (generic)
echo(
echo ===============================================================================
echo(
...
:: ---- TOAST START ----
adb shell am broadcast -a com.android.systemui.toast --es message "TechGuyTool: Locking Huawei OTA..." --ei duration 1 >nul 2>&1

:: ---- CLEAR + DISABLE ----
echo [*] Clearing updater state...
adb shell pm clear com.huawei.android.hwouc >nul 2>&1
adb shell pm clear com.huawei.updater >nul 2>&1

echo [*] Disabling updater services...
adb shell pm disable-user --user 0 com.huawei.android.hwouc >nul 2>&1
adb shell pm disable-user --user 0 com.huawei.updater >nul 2>&1

:: ---- DONE TOAST ----
adb shell am broadcast -a com.android.systemui.toast --es message "TechGuyTool: Huawei OTA - IDIOT PROOF ✅" --ei duration 1 >nul 2>&1
