@echo off
cls
title TECHGUYTOOL - LG OTA IDIOT PROOF
color 0A
...
echo(
echo   LG helper codes (model dependent):
echo     *#546368#*#   (LG service menu, model dependent)
echo     *#*#4636#*#*  (generic)
echo(
echo ===============================================================================
echo(
...
set DEVICE_OK=
for /f "tokens=2" %%i in ('adb devices ^| findstr /R "device$"') do set_DEVICE_OK=1
...
:: ---- TOAST START ----
adb shell am broadcast -a com.android.systemui.toast --es message "TechGuyTool: Locking LG OTA..." --ei duration 1 >nul 2>&1

:: ---- CLEAR + DISABLE ----
echo [*] Clearing updater state...
adb shell pm clear com.lge.update >nul 2>&1
adb shell pm clear com.lge.ota >nul 2>&1
adb shell pm clear com.android.providers.downloads >nul 2>&1

echo [*] Disabling updater services...
adb shell pm disable-user --user 0 com.lge.update >nul 2>&1
adb shell pm disable-user --user 0 com.lge.ota >nul 2>&1
adb shell pm disable-user --user 0 com.android.providers.downloads >nul 2>&1

:: ---- DONE TOAST ----
adb shell am broadcast -a com.android.systemui.toast --es message "TechGuyTool: LG OTA - IDIOT PROOF ✅" --ei duration 1 >nul 2>&1
